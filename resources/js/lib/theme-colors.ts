...
const themeColors: Record<ThemeColor, { light: ThemeColorSet; dark: ThemeColorSet }> = {
    ...
    cyan: {
        ...
        dark: {
            ...
            accent3: '#c4b5fd',
            accent4: '#6ee7b7',
            accent1Light: 'rgb(103, 232, 249 / 0.1)',
            accent1Dark: 'rgb(8, 145, 178 / 0.3)',
            accent2Light: 'rgb(34, 211, 238 / 0.1)',
            accent2Dark: 'rgb(6, 182, 212 / 0.3)',
            accent3Light: 'rgb(196, 181, 253 / 0.1)',
            accent3Dark: 'rgb(147, 51, 234 / 0.3)',
            accent4Light: 'rgb(110, 231, 183 / 0.1)',
            accent4Dark: 'rgb(5, 150, 105 / 0.3)',
        },
    },
    white: {
        light: {

...
import { ShoppingBag, ArrowRight, Zap, ChevronRight, LayoutGrid, Rocket } from 'lucide-react';
        ...
        <PublicLayout>
            ...
            <main className="flex-1 overflow-hidden" ref={heroRef}>
                ...
                <section className="relative min-h-[85vh] flex items-center py-12 lg:py-20 bg-background overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 -z-10 h-[300px] w-[300px] bg-blue-500/5 blur-[100px] rounded-full opacity-30" />
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                            ...
                            <div ref={leftColRef} className="z-10 flex flex-col items-start text-left">
                                <div className="animate-left flex items-center gap-3 px-4 py-2 rounded-2xl bg-muted border border-border/50 text-[var(--theme-primary)] text-[10px] font-black uppercase tracking-[0.3em] mb-8 shadow-sm">
                                    ...
                                    <span>Innovación y Rendimiento</span>
                                </div>
                                ...
                                <h1 className="animate-left text-5xl md:text-7xl lg:text-8xl font-black tracking-tight mb-8 leading-[0.9] italic uppercase">
                                    Define tu<br />
                                    <span className="text-[var(--theme-primary)] drop-shadow-[0_0_15px_var(--theme-primary)]">Potencial.</span>
                                </h1>

                                <p className="animate-left text-lg md:text-xl text-muted-foreground mb-12 max-w-lg leading-relaxed font-medium">
                                    Miranda ofrece curaduría de hardware premium diseñada para elevar la productividad al máximo nivel.
                                </p>
                            ...
                            <div ref={rightColRef} className="relative flex justify-center">
                                <div className="relative w-full aspect-video lg:aspect-[4/3] max-w-[650px] group">
                                    ...
                                    <div className="w-full h-full rounded-[3rem] border-4 border-white dark:border-white/10 shadow-[0_40px_80px_-15px_rgba(0,0,0,0.3)] overflow-hidden relative">
                                        <video
                                            autoPlay
                                            muted
                                            loop
                                        ...
                                        <div className="absolute top-8 right-8 bg-white/10 backdrop-blur-xl border border-white/20 p-4 rounded-3xl animate-bounce duration-[3000ms]">
                                            <Zap className="h-6 w-6 text-[var(--theme-primary)] fill-[var(--theme-primary)] shadow-[0_0_10px_var(--theme-primary)]" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section className="container mx-auto px-6 py-24">
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
                        <div className="max-w-xl">
                            <h2 className="text-5xl md:text-6xl font-black tracking-tighter leading-none mb-4 italic uppercase">Lo más deseado</h2>
                            <p className="text-muted-foreground text-xl font-medium">Equípate con las herramientas que están definiendo el futuro.</p>
                        </div>
                ...
                <section className="container mx-auto px-6 py-24 bg-muted/30 rounded-[4rem] mb-16 border border-border/50 shadow-inner overflow-hidden relative">
                    ...
                    <div className="text-center mb-16 relative z-10">
                        <h2 className="text-4xl md:text-5xl font-black tracking-tight mb-4 italic uppercase">Marcas que Confían</h2>
                        ...
                        {marcas.map((marca) => (
                            ...
                            >
                                <div className="h-16 w-16 rounded-2xl bg-muted flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-[var(--theme-primary)]/10 transition-all duration-500">
                                    <LayoutGrid className="h-8 w-8 text-muted-foreground group-hover:text-[var(--theme-primary)] transition-colors" />
                                </div>
                                <span className="font-black text-[10px] uppercase tracking-wider">{marca.nombre_marca}</span>
                            </Link>
                        ))}
                    </div>
                </section>
                ...
                <section className="container mx-auto px-6 py-24 mb-24">
                    <div className="flex flex-col md:flex-row items-center justify-between mb-16 gap-8 text-center md:text-left">
                        <div>
                            <h2 className="text-5xl font-black tracking-tight mb-4 italic uppercase leading-none">Ecosistema<br />Digital</h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {categorias.map((cat) => (
                            ...
                            >
                                ...
                                <h3 className="font-black text-2xl leading-tight mb-2 uppercase italic">{cat.nombre_cat}</h3>
